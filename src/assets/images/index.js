...
import giantlady from './giant-lady.png'
import bigfoot from './big-foot.png'
import quote from './quotation.png'
import folder from './folder.png'

export { member1, member2, member3, member4, member5, member6, giantlady, bigfoot, quote, folder };
